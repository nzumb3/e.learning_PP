 ...
 * Appointments Model
 *
 * @property \App\Model\Table\AppointmentContentsTable|\Cake\ORM\Association\BelongsTo $AppointmentContents
...
class AppointmentsTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->belongsTo('AppointmentContents', [
    ...
    {
        $rules->add($rules->existsIn(['appointment_content_id'], 'AppointmentContents'));
